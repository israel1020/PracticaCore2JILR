...
namespace PracticaCore2JILR
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            string libros = this.Configuration.GetConnectionString("cadenalibros");
            services.AddTransient<RepositoryLibros>();
            services.AddDbContext<LibrosContext>(options => options.UseSqlServer(libros));
